...
Эта система появилась в Google в начале нулевых, см. [историю её создания](https://habr.com/ru/articles/432324/) и [статью 2004 года](http://research.google.com/archive/mapreduce-osdi04.pdf). Используемая в Google реализация закрыта, но есть опенсорсная реализация в проекте Apache Hadoop.
